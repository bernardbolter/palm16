...
<div id="tv-interview_wrap">
	<div id="tv-interviews_loop_container">
		...
		<?php $args = array( 'post_type' => 'tv-factory', 'posts_per_page' => -1, 'order' => 'ASC' ); ?>
		<?php $photo_loop = new WP_Query( $args ); ?>
			...
			<div class="video_box">
					...
					<h2 class="video_desc"><?php echo get_field('tv_factory_desciption'); ?></h2>
				</a>
	 		</div> <!-- photo_box -->
