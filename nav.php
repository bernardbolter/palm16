	...
	<nav id="navigation" role="navigation">
		<ul id="nav_left">
			...
			<li class="tv_list">
				...
				<ul id="tv_drop">
					<li class="nav_tv-factory"><a href="<?php echo home_url( '/' ); ?>the-tv-factory"><i class="fa fa-plus awe_font"></i>THE TV-FACTORY</a></li>
					<li class="nav_tv-interviews"><a href="<?php echo home_url( '/' ); ?>tv-interviews"><i class="fa fa-plus awe_font"></i>TV-INTERVIEWS</a></li>
				</ul> <!-- articles_drop -->
				</li>
			<li class="radio_list">
